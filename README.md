# A fork for [Rainbow CSV](https://github.com/mechatroner/vscode_rainbow_csv) to fix alignment with East Asian characters([#69](https://github.com/mechatroner/vscode_rainbow_csv/issues/69))

一个修复 Rainbow CSV 无法对齐中日韩字符问题的复刻仓库

To install it, you should first disable the original extension.
